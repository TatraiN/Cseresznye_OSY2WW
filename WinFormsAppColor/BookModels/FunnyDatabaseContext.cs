...
public partial class FunnyDatabaseContext : DbContext
{
    ...
    public virtual DbSet<ColorsAndMeaning> ColorsAndMeanings { get; set; }

    public virtual DbSet<Film> Films { get; set; }

    public virtual DbSet<HauntedPlace> HauntedPlaces { get; set; }

    public virtual DbSet<HistoricalLeader> HistoricalLeaders { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BandId).HasName("PK__Bands__A036938890C52388");
        ...
        {
            entity.HasKey(e => e.ColorId).HasName("PK__ColorsAn__8DA7676D6CD8439B");
        ...
        {
            entity.HasKey(e => e.LeaderId).HasName("PK__Historic__FCCA65F617A96891");
